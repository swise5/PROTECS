...
public class MalariaDiseaseProgressionFramework extends DiseaseProgressionBehaviourFramework{
	...
	public MalariaDiseaseProgressionFramework(WorldBankCovid19Sim world) {
		super(world);
